...
function calculatepipelengthheadloss() {
      ...
      var pipediameter = parseInt((document.getElementById('pipediameter')).value);
      var calcpipelengthheadloss = 0.002083 * pipelength * (100/130)**1.85 * (calcgpm**1.85 / pipediameter**4.8655);
